...
// +) 제네릭과 타입 단언 활용
function pariFunc<T, U>(first: T, second: T): U {
  return [first, second] as U;
  
  // A as U: 타입 단언
  // -> A(T[])을 U 타입으로 간주하겠다. 
}
console.log(pariFunc<string, string[]>('hello', 'hi'));
