...
// cf) 문서 객체는 생성한 뒤 '배치'까지 필수
// >> DOM 트리 구조 내부에 삽입

// ? 부모객체.appendChild(자식객체)
//  : 선택된 부모 요소의 자식 요소 리스트 제일 마지막에 추가됨
...
// : 문서 객체를 다른 문서 객체에 추가시, 기존 배치가 사라지고, 새로운 부모 요소를 갖게 됨\
...
document.addEventListener('DOMContentLoaded', () => {
  setTimeout(() => {
    ...
    //    > removeChild() 사용시 parentNode 사용하여 부모 객체 지정하고 사용

    // a >> b >> c >> d
    // d요소.parentNode === c 요소 반환
