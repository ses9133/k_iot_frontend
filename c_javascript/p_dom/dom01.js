...
// ! DOM 사용 방법
// : JS 에서 HTML 의 요소를 문서 객체로서 선택/추가/수정/삭제하는 메서드와 속성 사용

// ! DOM 조작 방법
// 1) DOMContentLoaded 이벤트
// : JS 내에서 문서 객체 조작시 HTML 의 모든 문서 구조(내용)가 모두 로드된 이후에 이벤트 발생
...
document.addEventListener('DOMContentLoaded', () => {
  // querySelector
  // : 요소를 단 한개만 추출(여러개일 경우 제일 상단의 요소를 가져옴)
