...
// 1. 기본 자료형
// : string, number, boolean, null & undefined  >> 최상위: object
...
// +) 템플릿 문자열: 문자열 내 변수나 표현식 사용이 가능한 문자열 
//    >> 백틱 사용
...
// value가 false 인 경우: 값이 존재하지 않는 경우
...
let notANumber = '이건 숫자로 바꿀수없는 문자열';
console.log(Number(notANumber)); // NaN: 숫자로 변환할 수 없는 값 변환 시도할 경우
